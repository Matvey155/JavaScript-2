...
function t1() {
    ...
    output = output.slice(0, -1); // Удалить последний символ "_"
    document.querySelector('.out-1').textContent = output;
}
...
function t2() {
    ...
    output = output.slice(0, -1); // Удалить последний символ "_"
    document.querySelector('.out-2').textContent = output;
}
...
function t3() {
    ...
    output = output.slice(0, -1); // Удалить последний символ "_"
    document.querySelector('.out-3').textContent = output;
}
...
function t4() {
    ...
    output = output.slice(0, -1); // Удаляем последний лишний символ "_"
...
function t6() {
    let output = "";
    const rows = document.querySelector(".i-6").value;
...
function t10() {
    ...
    for (let year = 1950; year <= 1966; year += 2) {
...
function t15() {
    ...
    document.querySelector(".out-15").textContent = output;
}
